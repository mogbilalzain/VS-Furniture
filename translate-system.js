...
const translations = {
  ...
  'إدارة كاملة لهذه الخصائص من خلال لوحة التحكم عند إدارة الفئة': 'Complete management of these properties through the control panel when managing the category',
  'ماهي خطتك لاجراء هذه التعديلات واخبرني ماذا سوف تعمل اولا قبل التنفيذ': 'What is your plan to make these modifications and tell me what you will do first before execution',
  'إدارة وإضافة ملف pdf خاص بالمنتج ومن ضمن تفاصيل المنتج ويمكن للعميل تنزيل هذا الملف ويمكن من الادمن ادارة كل هذه التفاصيل': 'Manage and add a PDF file specific to the product as part of the product details, which the customer can download, and the admin can manage all these details'
};
