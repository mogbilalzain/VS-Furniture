  ...
  return (
    <>
      ...
      <section id="jobs" className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-normal text-gray-800 mb-4">Open Positions</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Job Cards */}
            <div className="bg-white border-t-4 border-yellow-400 p-8 shadow-lg hover:-translate-y-1 transition-all duration-300">
              <div className="text-green-700 font-medium mb-2">Design</div>
              <h3 className="text-2xl font-semibold text-gray-800 mb-2">Senior Product Designer</h3>
              <div className="text-gray-600 mb-4 flex items-center">
                <i className="fas fa-map-marker-alt mr-2"></i>
                Sharjah, UAE
              </div>
              <p className="text-gray-600 mb-6 leading-relaxed">
                Lead the design of innovative furniture solutions for educational environments. Work with cross-functional teams to create user-centered designs.
              </p>
              <button className="bg-yellow-400 hover:bg-yellow-500 text-black font-semibold px-6 py-2 transition-all duration-300 hover:-translate-y-1">
                Apply Now
              </button>
            </div>

            <div className="bg-white border-t-4 border-yellow-400 p-8 shadow-lg hover:-translate-y-1 transition-all duration-300">
              <div className="text-green-700 font-medium mb-2">Engineering</div>
              <h3 className="text-2xl font-semibold text-gray-800 mb-2">Manufacturing Engineer</h3>
              <div className="text-gray-600 mb-4 flex items-center">
                <i className="fas fa-map-marker-alt mr-2"></i>
                Sharjah, UAE
              </div>
              <p className="text-gray-600 mb-6 leading-relaxed">
                Optimize manufacturing processes and ensure quality standards. Collaborate with design teams to bring innovative products to market.
              </p>
              <button className="bg-yellow-400 hover:bg-yellow-500 text-black font-semibold px-6 py-2 transition-all duration-300 hover:-translate-y-1">
                Apply Now
              </button>
            ...
            <div className="bg-white border-t-4 border-yellow-400 p-8 shadow-lg hover:-translate-y-1 transition-all duration-300">
              <div className="text-green-700 font-medium mb-2">Sales</div>
              <h3 className="text-2xl font-semibold text-gray-800 mb-2">Sales Manager</h3>
              <div className="text-gray-600 mb-4 flex items-center">
                <i className="fas fa-map-marker-alt mr-2"></i>
                Dubai, UAE
              </div>
              <p className="text-gray-600 mb-6 leading-relaxed">
                Drive sales growth and build relationships with educational institutions. Develop strategies to expand our market presence.
              </p>
              <button className="bg-yellow-400 hover:bg-yellow-500 text-black font-semibold px-6 py-2 transition-all duration-300 hover:-translate-y-1">
                Apply Now
              </button>
            ...
            <div className="bg-white border-t-4 border-yellow-400 p-8 shadow-lg hover:-translate-y-1 transition-all duration-300">
              <div className="text-green-700 font-medium mb-2">Marketing</div>
              <h3 className="text-2xl font-semibold text-gray-800 mb-2">Digital Marketing Specialist</h3>
              <div className="text-gray-600 mb-4 flex items-center">
                <i className="fas fa-map-marker-alt mr-2"></i>
                Remote
              </div>
              <p className="text-gray-600 mb-6 leading-relaxed">
                Develop and execute digital marketing campaigns to promote our furniture solutions. Manage social media and online presence.
              </p>
              <button className="bg-yellow-400 hover:bg-yellow-500 text-black font-semibold px-6 py-2 transition-all duration-300 hover:-translate-y-1">
                Apply Now
              </button>
            ...
            <div className="bg-white border-t-4 border-yellow-400 p-8 shadow-lg hover:-translate-y-1 transition-all duration-300">
              <div className="text-green-700 font-medium mb-2">Quality Assurance</div>
              <h3 className="text-2xl font-semibold text-gray-800 mb-2">Quality Control Manager</h3>
              <div className="text-gray-600 mb-4 flex items-center">
                <i className="fas fa-map-marker-alt mr-2"></i>
                Sharjah, UAE
              </div>
              <p className="text-gray-600 mb-6 leading-relaxed">
                Ensure all products meet our high-quality standards. Implement quality control processes and continuous improvement initiatives.
              </p>
              <button className="bg-yellow-400 hover:bg-yellow-500 text-black font-semibold px-6 py-2 transition-all duration-300 hover:-translate-y-1">
                Apply Now
              </button>
            ...
            <div className="bg-white border-t-4 border-yellow-400 p-8 shadow-lg hover:-translate-y-1 transition-all duration-300">
              <div className="text-green-700 font-medium mb-2">Human Resources</div>
              <h3 className="text-2xl font-semibold text-gray-800 mb-2">HR Business Partner</h3>
              <div className="text-gray-600 mb-4 flex items-center">
                <i className="fas fa-map-marker-alt mr-2"></i>
                Sharjah, UAE
              </div>
              <p className="text-gray-600 mb-6 leading-relaxed">
                Support our growing team with recruitment, employee development, and HR operations. Foster a positive work culture.
              </p>
              <button className="bg-yellow-400 hover:bg-yellow-500 text-black font-semibold px-6 py-2 transition-all duration-300 hover:-translate-y-1">
                Apply Now
              </button>
